...
class SipdscraperSpiderMiddleware:
...
class SipdscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.authorization = settings.get("TOKEN_AUTHORIZE")
        self.referer = settings.get("REFERER")
        self.origin = settings.get("ORIGIN")
        self.header_list = []
    ...
    def _get_random_browser_header(self):
        random_index = randint(0, len(self.header_list) - 1)
